...
const sukyoSongTranslationByXiu: Record<string, string> = {
  角: "시작을 밀어붙이는 힘이 강한 숙입니다. 새 일의 착수, 약속 정리, 관계의 방향 설정에는 좋지만 감정이 앞서면 충돌이 커질 수 있습니다.",
  亢: "기세와 자존이 강하게 드러나는 숙입니다. 성과를 내고 존재감을 보이는 데 유리하지만, 고집이 세지면 관계 마찰이 쉽게 생깁니다.",
  氐: "기반을 다지고 현실을 정리하는 힘이 강한 숙입니다. 생활 안정과 실무에는 좋지만, 답답함이 쌓이면 감정 표현이 거칠어질 수 있습니다.",
  房: "관계와 생활의 균형을 잡는 데 강점이 있는 숙입니다. 정착, 협력, 살림 감각에는 좋고, 애정 문제도 안정적으로 풀기 쉽습니다.",
  心: "감정의 밀도가 높은 숙입니다. 좋아하는 마음과 집착이 함께 커질 수 있어 애정과 인간관계에서 호불호가 분명하게 드러납니다.",
  尾: "확장성과 성장성이 좋은 숙입니다. 사람을 모으고 흐름을 넓히는 데 유리하지만, 지나친 기대나 낙관은 피하는 편이 좋습니다.",
  箕: "성취 욕구와 추진력이 강한 숙입니다. 일과 계획을 크게 벌리기에는 좋지만, 강한 주도권이 상대에게 압박으로 느껴질 수 있습니다.",
  斗: "질서를 세우고 원칙을 지키는 힘이 강한 숙입니다. 장기 계획, 공부, 기준 정립에는 좋지만 융통성이 부족해 보일 수 있습니다.",
  牛: "꾸준함과 인내가 장점인 숙입니다. 느리더라도 안정적으로 쌓아가는 데 강하고, 관계도 천천히 깊어지는 흐름이 잘 맞습니다.",
  女: "감수성과 섬세함이 돋보이는 숙입니다. 미감, 배려, 정서적 교류에는 좋지만 예민함이 커지면 상처를 오래 끌 수 있습니다.",
  虚: "비움과 전환의 기운이 강한 숙입니다. 무리한 확장보다 정리와 거리두기에 맞고, 감정 기복이 클 때는 혼자 호흡을 고르는 편이 좋습니다.",
  危: "변화 대응과 감각적 판단이 빠른 숙입니다. 순간 대처에는 강하지만 불안이 높아지면 관계에서도 예민함이 앞설 수 있습니다.",
  室: "생활 기반과 보호 본능이 강한 숙입니다. 집, 가족, 가까운 관계를 지키는 데 강점이 있고, 안정감을 주는 사람으로 보이기 쉽습니다.",
  壁: "방어와 기준 설정에 강한 숙입니다. 자기 세계를 잘 지키지만, 벽을 너무 높이면 사람들과의 심리적 거리가 벌어질 수 있습니다.",
  奎: "표현력과 기획력이 좋은 숙입니다. 말, 글, 창작, 아이디어 전개에 강점이 있지만 완성 전에 힘이 분산되지 않게 관리가 필요합니다.",
  婁: "실속과 수습 능력이 뛰어난 숙입니다. 관계를 다듬고 흐트러진 판을 정리하는 데 강하지만, 디테일에 과몰입하면 피로가 빨리 옵니다.",
  胃: "먹고사는 문제와 현실 감각에 강한 숙입니다. 경제 감각과 생활 안정에는 좋지만 편안함만 좇으면 추진력이 떨어질 수 있습니다.",
  昴: "자존감과 존재감이 강하게 드러나는 숙입니다. 사람들 사이에서 눈에 띄기 쉽고 리더십도 있지만, 자존심 싸움은 경계해야 합니다.",
  畢: "끝까지 밀고 가는 완결력이 강한 숙입니다. 마무리와 책임감에는 좋지만, 긴장을 오래 끌면 정서적으로 경직될 수 있습니다.",
  觜: "말과 태도에 힘이 실리는 숙입니다. 설득력과 판단은 좋지만, 감정이 실린 한마디가 크게 남을 수 있어 표현 수위를 조절하는 편이 좋습니다.",
  参: "활동성과 승부욕이 강한 숙입니다. 빠르게 움직이고 결과를 내는 데 유리하지만, 쉼 없이 달리면 관계와 감정이 메마르기 쉽습니다.",
  井: "흐름을 조율하고 연결하는 능력이 좋은 숙입니다. 사람과 정보, 역할을 잇는 데 강하고 중재자 역할도 잘합니다.",
  鬼: "감정의 그림자와 직관이 함께 강한 숙입니다. 통찰은 깊지만 기복이 커질 수 있어 관계에서는 과해석을 줄이는 편이 좋습니다.",
  柳: "부드럽고 유연한 흐름을 만드는 숙입니다. 사람을 편하게 하고 정서를 나누는 데 좋지만, 우유부단해 보이지 않도록 중심을 잡아야 합니다.",
  星: "주목도와 화려함이 강한 숙입니다. 매력, 표현, 무대성이 살아나지만 들뜸이 커지면 실속이 약해질 수 있습니다.",
  張: "확장, 홍보, 외연 확대에 강한 숙입니다. 사람을 끌고 기회를 넓히는 데 유리하지만, 벌인 일의 수습까지 함께 봐야 안정적입니다.",
  翼: "보조와 지원, 팀워크 감각이 좋은 숙입니다. 관계를 살리고 사람을 세우는 데 강점이 있지만 자기 욕구를 너무 뒤로 미루진 않는 편이 좋습니다.",
  軫: "균형 감각과 마무리 판단이 좋은 숙입니다. 상황을 종합해 정리하는 데 강하고, 관계에서도 선을 지키며 현실적으로 움직이는 편입니다.",
};

function translateSukyoSong(xiu: string, xiuSong: string): string {
  return (
    sukyoSongTranslationByXiu[xiu] ??
    (xiuSong.trim().length > 0
      ? "전통 원문 기준으로 길흉과 적합한 일의 성향을 뜻하는 숙요 해석입니다. 현재 화면에서는 이해하기 쉽게 한국어 요약으로만 보여줍니다."
      : "숙요 전통 해석 원문이 없어 요약 해석만 제공합니다.")
  );
}
...
function buildSukyoResult(profile: ParsedBirthProfile, _question: string): ToolExecutionResult {
  ...
  const translatedXiuSong = translateSukyoSong(xiu, xiuSong);
